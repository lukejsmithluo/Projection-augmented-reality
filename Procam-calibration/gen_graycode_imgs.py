...
def main():
    parser = argparse.ArgumentParser(description="Generate graycode pattern images")
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="step size of graycode [default:1](increase if moire appears)",
    )
    ...
    print(
        "'"
        + TARGETDIR
        + "/pattern_00.png ~ pattern_"
        + str(len(exp_patterns) - 1)
        + ".png ' were generated"
    )
    print()
    print("=== Next step ===")
    print(
        "Project patterns and save captured images as '"
        + CAPTUREDDIR
        + "/graycode_*.png'"
    )
    print()
    print(
        ...
        "        |              |        .\n"
        "        |              |        .\n"
        "        |              |- graycode_" + str(len(exp_patterns) - 1) + ".png\n"
