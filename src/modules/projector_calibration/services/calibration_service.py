...
class CalibrationService:
    ...
    def run_calibration(self, 
        ...
        return self._calibrate_logic(used_dirnames, gc_fname_lists, proj_shape, chess_shape, chess_block_size, gc_step, black_thr, white_thr, camP, cam_dist, input_dir)

    def _calibrate_logic(self, dirnames, gc_fname_lists, proj_shape, chess_shape, chess_block_size, gc_step, black_thr, white_thr, camP, camD, output_base_dir):
        ...
        proj_objps_list = []
        proj_corners_list = []
        cam_corners_list2 = [] # For stereo calibration (subset where projector points were also found)
        ...
        ret_proj, proj_int, proj_dist, proj_rvecs, proj_tvecs = cv2.calibrateCamera(
            proj_objps_list, proj_corners_list, (proj_shape[1], proj_shape[0]), None, None, None, None)
        ...
        ret_stereo, cam_int, cam_dist, proj_int, proj_dist, cam_proj_rmat, cam_proj_tvec, E, F = cv2.stereoCalibrate(
        ...
        return {
            ...
            "rms": ret_stereo,
            "camera": {
                "intrinsic": cam_int.tolist(),
                "distortion": cam_dist.tolist()
            },
            "projector": {
